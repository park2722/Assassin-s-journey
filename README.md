...
내가 구현해야되는 거를 하나씩 적어보자.

- [x] 1. 휴대폰과 노트북 연결을 어떻게 할 것인가?

- [x] 2. 몇X몇 chessboard를 할 것인가?
          -> 26.05.24 8 X 6으로 결정했지만 우선 테스트는 10 X 7로 진행
- [x] 3. 카메라 파라미터를 어떻게 구할 것인가.

- [ ] 4. 노트북 카메라를 통해 내 제스처를 어떻게 구분할 것인가?

- [ ] 5. 3D 에셋을 어떻게 화면에 띄울 것인가?

- [x] 6. 선택지 UI를 어떻게 만들 것이고, 화면 비율 변화에 대해서는 어떻게 조정할 것인가.
